...
const start1: Color = Color(0.8, 0.8, 0.8, 0.7)
const start2: Color = Color(0.8, 0.8, 0.8, 0.6)
const hovered1: Color = Color(0.9, 0.9, 0.9, 0.9)
const hovered2: Color = Color(0.9, 0.9, 0.9, 0.8)
